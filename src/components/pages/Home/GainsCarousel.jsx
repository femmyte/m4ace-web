...
function Item(props) {
	return (
		<div className='flex flex-col justify-center w-full md:w-[25.875rem] md:ml-20 h-[22rem] md:h-[18.125rem] bg-secondary py-6 px-10 rounded-3xl'>
			<div className='flex items-center justify-center rounded-full bg-[#F5BF80] h-14 w-14'>
				<Image
